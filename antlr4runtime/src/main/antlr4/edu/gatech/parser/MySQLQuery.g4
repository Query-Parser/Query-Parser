...
sumClause:
    SUM_SYMBOL OPEN_PAR_SYMBOL columnName (ARITHMETIC (NUMBER | columnName))* CLOSE_PAR_SYMBOL
;

countClause:
     COUNT_SYMBOL OPEN_PAR_SYMBOL columnItem (ARITHMETIC (NUMBER | columnName))* CLOSE_PAR_SYMBOL
;

avgClause:
    AVERAGE_SYMBOL OPEN_PAR_SYMBOL columnItem (ARITHMETIC (NUMBER | columnName))* CLOSE_PAR_SYMBOL
;

minClause:
    MIN_SYMBOL OPEN_PAR_SYMBOL columnItem (ARITHMETIC (NUMBER | columnName))* CLOSE_PAR_SYMBOL
;

maxClause:
    MAX_SYMBOL OPEN_PAR_SYMBOL columnItem (ARITHMETIC (NUMBER | columnName))* CLOSE_PAR_SYMBOL
;
